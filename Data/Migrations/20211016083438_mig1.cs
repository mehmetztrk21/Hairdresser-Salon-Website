    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntrySliders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    Saloon_img = table.Column<string>(type: "TEXT", nullable: true),
                    Saloon_Context = table.Column<string>(type: "TEXT", nullable: true),
                    About_Context = table.Column<string>(type: "TEXT", nullable: true),
